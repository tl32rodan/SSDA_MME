...
parser.add_argument('--checkpath', type=str, default='./save',
...
parser.add_argument('--source', type=str, default='Strain',
                    help='source domain')
parser.add_argument('--target', type=str, default='Ttrain',
                    help='target domain')
